<x-layouts.base>
    ...
    <div class="title align-middle text-center">
        ...
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Puedes editar (<i class="ri-pencil-fill"></i>)
            los existentes, ver (<i class="ri-eye-fill"></i>) sus stands (<i class="ri-store-2-line"></i>) correspondientes o crear (<i class="ri-add-fill"></i>)
            uno nuevo. <span href="#"
