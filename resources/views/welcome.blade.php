<x-layouts.base>
    <div class="mx-auto max-w-md rounded-lg bg-fitectur-red shadow text-white">
        <div class="p-4">
          <h3 class="text-xl font-medium text-white">Migrating to Sailboat UI</h3>
          <p class="mt-1 text-fitectur-test-a">Sailboat UI is a modern UI component library for Tailwind CSS. Get started with 150+ open source components.</p>
        </div>
      </div>
